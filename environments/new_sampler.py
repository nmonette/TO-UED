...
SCORE_FUNCTIONS = ["random", "frozen", "alg_regret", "eval_regret"]
...
class LevelSampler:
    ...
    def initial_sample(
        ...
        dist = jnp.unique(levels.buffer_id, return_counts=True, size=len(levels.buffer_id))[1]
        dist = dist / dist.sum()
        ...
        return level_buffer, agent_states, value_critics, dist
    ...
    def sample(
        ...
        eval_buffer: LevelBuffer,
        lpg_train_state: TrainState,
        train_sample_dist: jnp.ndarray
    ):
        ...
        if self.score_function == "random":
            ...
            if self.score_function == "alg_regret":
            ...
            elif self.score_function == "eval_regret":
                ...
                # TODO: calculate sample dist for eval
                ...
                score = train_sample_dist * jnp.dot(eval_dist, eval_regrets)
            ...
            train_dist = jnp.unique(new_levels.buffer_id, return_counts=True, size=len(new_levels.buffer_id))[1]
            train_dist = eval_dist / eval_dist.sum()
        ...
        return level_buffer, eval_buffer, agent_states, value_critics, train_dist
